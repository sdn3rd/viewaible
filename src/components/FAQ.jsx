...
const FAQS = [
  ...
  },
  {
    ...
    a: 'A VPS (any provider — DigitalOcean, Hetzner, Linode, etc.) running a supported Linux distro. Run our setup script, point a DNS record at it, and connect.',
  },
  {
    q: 'Is my VPS connection secure?',
    a: 'Your VPS address is stored in a server-side HttpOnly cookie — never visible in the browser, page source, or dev tools. The connection from your browser to viewAIble is encrypted via Cloudflare SSL.',
  },
  {
    q: 'Why do I need a DNS hostname?',
    a: 'Cloudflare Workers route connections through their network, which requires a DNS hostname. You can use a DNS-only (grey cloud) Cloudflare record, or just enter an IP — we auto-route it through sslip.io.',
  },
  {
